    ...
    public EditCustomer() {
        ...
        //Panels
            ...
            rootPanel.add(bodyPanel, BorderLayout.CENTER);
                ...
                // Customer ID row
                JLabel idLabel = new JLabel("Customer ID  (non-editable)");
                ...
                idField.setBorder(BorderFactory.createCompoundBorder(
                        BorderFactory.createLineBorder(new Color(204, 204, 204)), //outer border
                ...
                updateButton.setBackground(new Color(218, 87, 0));
